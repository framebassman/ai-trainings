...
from ai_trainings.dspy_experiments.summarization.metric import Metric
from ai_trainings.dspy_experiments.summarization.summary_correctness import Summarize
...
def start():
    ...
    with open('ai_trainings/dspy_experiments/summarization/dataset.json', 'r', encoding='utf-8') as f:
        content = f.read()
